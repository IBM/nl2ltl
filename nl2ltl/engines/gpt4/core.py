...
from nl2ltl.engines.gpt4 import ENGINE_ROOT
from nl2ltl.engines.gpt4.output import GPT4Output, parse_gpt4_output, parse_gpt4_result
...
def _process_utterance(
    ...
    gpt4_result: GPT4Output = parse_gpt4_output(prediction)
    matching_formulas: Dict[Formula, float] = parse_gpt4_result(gpt4_result, filtering)
